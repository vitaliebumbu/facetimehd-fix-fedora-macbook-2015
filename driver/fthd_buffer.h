 ...
 *   - Added fthd_send_h2t_buffer() declaration so the workqueue
 *     in fthd_v4l2.c can submit buffers to the hardware.
 *
...
extern int fthd_send_h2t_buffer(struct fthd_private *dev_priv, struct h2t_buf_ctx *ctx);
